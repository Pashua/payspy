...
module.exports = function (grunt) {
	grunt.initConfig({
		...
		*/
		...
		// Compile SASS/Compass (.scss) files to CSS (.css).
		compass: {
			dev: {
		...
		copy: {
			...
			temp: {
				files: {
					...
					'./temp/img/': './src/img/',
					'./temp/api/': './src/api/',
					'./temp/styles/images/': './src/styles/images/'
				}
			},
			/*
			...
			*/
			prod: {
				files: {
					...
					'./dist/styles/': './temp/styles/main.min.css',
		...
		*/
		...
		watch: {
			...
			styles: {
				...
				tasks: 'compass:dev copy:styles reload'
			},
			index: {
	...
	*/
	...
	/*
		Register a grunt task wrapping compass.
		Referenced in package.json.
